...
//     return (
//         <form onSubmit={handleSubmit}>
//             <input type="text" value={title} onChange={({target: {value}}) => setDescription(value)}
//                    placeholder="todo title"/>
//             <br/>
//             <br/>
//             <input type="text" value={description} onChange={({target: {value}}) => setDescription(value)}
...
//             <br/>
//             <br/>
//             <button type="submit" disabled={!title || !description || isLoading}>creat to do</button>
//         </form>
//     )
// }
//
// const Todos = ({todos, isLoading}) =>{
//     if (isLoading) return <h1>Loading ... Your info wait 1 second</h1>
//     return (
//      <div>
//          {todos.map(todo=>(
//           <Fragment key={todo.id}>
//               <div>{todo.title}</div>
//               <div>{todo.description}</div>
//               <div>Create At:{new Date(todo.createdAd).toDateString()}</div>
//               <div>Status {todo.completed.toString()}</div>
//           </Fragment>
//          ))}
//      </div>
